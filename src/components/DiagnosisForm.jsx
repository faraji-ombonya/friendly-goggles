...
export default function DiagnosisForm({ setResult, setOpen }) {
  ...
  return (
    <>
      <h1 className="mt-24 text-xl font-bold leading-7 text-gray-900">
            ...
            <div className="mt-10 grid grid-cols-1 sm:grid-cols-6 md:grid-cols-9 lg:grid-cols-12 gap-x-6 gap-y-8">
              ...
              <div className="sm:col-span-3">
                <label
                  ...
                  className="block text-sm font-medium leading-6 text-gray-900"
                >
                  How many of the past 30 days did you experience poor physical
                  health?
                </label>
                <div className="mt-2">
                  <input
              ...
              <div className="sm:col-span-3">
                <label
                  ...
                  className="block text-sm font-medium leading-6 text-gray-900"
                >
                  How many of the past 30 days did you experience poor mental
                  health?
                </label>
                <div className="mt-2">
                  <input
